...
for p in ports:
    if 'COM13' in p.device:  # Replace 'COM3' with the name of your serial port
        port = p.device
        break
...
@app.route('/diagnosis_form')
def diagnosis_form():
    return render_template('df.html')

@app.route('/diagnose_input')
def diagnose_input():
...
alarm_sound = pygame.mixer.Sound(r'C:\Users\RC\Desktop\Dr_ppls (1)\project\alarm_sound.mp3')
